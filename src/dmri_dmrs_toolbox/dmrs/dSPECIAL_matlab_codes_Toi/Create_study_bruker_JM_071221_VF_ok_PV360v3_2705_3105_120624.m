...
% svaed .mat file contains the study with study.data and study.datajob0
% modified by CC to save and display the ref scan also for different PV
% versions
clear; close all;

%% Enter exp nb. + directory and run the program 

folderexp="Z:\DATA\CSI\9.4T-FIDCSI-Data\20250417_084715_Toi_dMRSI_20250417_RatFem_dMRI_SPECIAL_dMRS_1_1_10\";
expnb=31;
timeacq='_dMRS_b1000_0506Test_dwspecial';%'_BDL727';%'' or am or pm no need to add date - it is done automatically 
dateexp='2025'; % add the year when exp was done
...
BRUKERparamnames=["PVM_SpecAcquisitionTime=","##$PVM_SpecSWH=( 1 )", ...
    ...
    "PVM_NRepetitions=","PVM_NAverages=","PVM_EchoTime=",["##$PVM_ArrayPhase=( 4 )" + sprintf('\n')]];
...
plot(real(sum(ftsaved)),'DisplayName','rawdatajob0')
legend()
title(num2str(expnb)) 
