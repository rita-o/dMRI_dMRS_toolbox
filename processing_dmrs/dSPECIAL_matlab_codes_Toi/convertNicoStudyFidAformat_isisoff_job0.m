function out = convertNicoStudyFidAformat_isisoff_job0(folder,identifier)
%% load ser
load([folder '/' identifier])
out.fids=squeeze(study.datajob0.real)+1i*squeeze(study.datajob0.imag);
out.fids=out.fids(2:2:end,:); 
